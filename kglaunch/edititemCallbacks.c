...
int  edititemtextbox1callback(int cellno,int i,void *Tmp) {
  ...
  e = T->elmt;
  strcpy(Name,(char *)kgGetString(T,0));
  return ret;
}
int  edititembutton1callback(int butno,int i,void *Tmp) {
  ...
  kgSelectImage(NULL,30,30,64,Icon);
  chdir(buff);
  kgSetString(kgGetWidget(D,2),0,Icon);
  kgUpdateWidget(kgGetWidget(D,2));
  switch(butno) {
    case 1: 
      break;
  }
...
int  edititemtextbox2callback(int cellno,int i,void *Tmp) {
  ...
  T = (DIT *)kgGetWidget(Tmp,i);
  e = T->elmt;
  strcpy(Icon,(char *)kgGetString(T,0));
  return ret;
}
int  edititemtextbox3callback(int cellno,int i,void *Tmp) {
  ...
  T = (DIT *)kgGetWidget(Tmp,i);
  e = T->elmt;
  strcpy(Command,(char *)kgGetString(T,0));
  return ret;
}
int  edititembutton2callback(int butno,int i,void *Tmp) {
  ...
  B = (DIN *)kgGetWidget(Tmp,i);
  n = B->nx*B->ny;
  kgFolderBrowser(NULL,30,30,Command,"*");
  kgSetString(kgGetWidget(D,3),0,Command);
  kgUpdateWidget(kgGetWidget(D,3));
  switch(butno) {
    case 1: 
      break;
  }
...
int  edititemsplbutton1callback(int butno,int i,void *Tmp) {
  ...
  switch(butno) {
    case 1: 
      break;
    case 2: 
      strcpy(Name,(char *)kgGetString(kgGetWidget(D,0),0));
      strcpy(Icon,(char *)kgGetString(kgGetWidget(D,2),0));
      strcpy(Command,(char *)kgGetString(kgGetWidget(D,3),0));
      break;
  }
  return ret;
}
